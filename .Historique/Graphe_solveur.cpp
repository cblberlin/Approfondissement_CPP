...
bool Graphe_solveur::solve(vector<int> & vois, vector<int> & Zahl_Farben) {
    ...
    int min_couleur = min(Zahl_Farbe.begin(), Zahl_Farbe.end(), [] (int i) {return color[i] == -1});
    ...
    int sommet_cible = distance(Zahl_Farbe.begin(), min_couleur);
